...
function theme_scripts() {
	...
	// Load default JS
	wp_enqueue_script( 'jqueryscript', get_template_directory_uri() . '/js/jquery-1.9.1.min.js');
	wp_enqueue_script( 'jquery-ui-script', get_template_directory_uri() . '/js/jquery-ui-1.10.4.custom.min');
	...
	register_post_type( 'portfolio', /* this can be seen at the URL as a parameter and a unique id for the custom post */
		array(
			'labels' => array(
				...
				'singular_name' => __( "All Portfolio", 'textdomain_finale' ) /* The Label of the custom post */
			),
			'public' => true,
			'has_archive' => true,
