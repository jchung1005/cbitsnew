...
bitnami-wordpress-3.9-0-linux-installer.run on Linux or
bitnami-wordpress-3.9-0-linux-x64-installer.run on Linux 64 bit or
bitnami-wordpress-3.9-0-windows-installer.exe on Windows or
bitnami-wordpress-3.9-0-osx-x86-installer.dmg on OS X x86.

On Linux, you will need to give it executable permissions:

chmod 755 bitnami-wordpress-3.9-0-linux.run
...
Stack in /home/user/wordpress-3.9-0 on Linux or C:\Program Files\Bitnami WordPress Stack
on Windows or /Applications/wordpress-3.9-0 on OS X and that you use port 8080 
...
/home/user/wordpress-3.9-0/apache2/logs/error.log on Linux or
C:\Program Files\Bitnami WordPress Stack\apache2\logs\error.log on Windows or
/Applications/wordpress-3.9-0/apache2/logs/error.log.
