...
function theme_scripts() {
	...
	wp_enqueue_script( 'nlform', get_template_directory_uri() . '/js/nlform.js', array(), true, true);
	wp_enqueue_script( 'modernizr', get_template_directory_uri() . '/js/modernizr.custom.js', array(), true, true);
...
function shortcode_simple_separator() {
	...
	// Code
	return '<div><hr class="line bottom-3"></div><!-- End line -->';
...
// ----------- Service Item -----------
// [simple_service_item link="#" img="img-url.jpg" name='Joe Shmoe'] ... [/simple_service_item]
function shortcode_simple_profile( $atts, $content = null ) {

	// Attributes
	extract( shortcode_atts(
		array(
			'link' => '#',
			'img' => 'http://www.placekitten.com/140/140/',
			'name' => 'Joe Shmoe',
...
add_shortcode( 'simple_profile', 'shortcode_simple_profile' );
